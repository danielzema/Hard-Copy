...
custom_style = Style([
    ...
    ('question', 'fg:#E8F1F2 bold'),               # Alice Blue
    ('answer', 'fg:#1B98E0 bold'),                 # Blue Bell
    ('pointer', 'fg:#1B98E0 bold'),                # Blue Bell
    ('highlighted', 'fg:#1B98E0 bold'),            # Blue Bell
    ('selected', 'fg:#247BA0'),                    # Cerulean
    ('separator', 'fg:#006494'),                   # Baltic Blue
    ('instruction', 'fg:#006494 italic'),          # Baltic Blue
    ('text', 'fg:#E8F1F2'),                        # Alice Blue
])
